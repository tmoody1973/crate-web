    ...
    case "tumblr": {
      ...
      if (arg.toLowerCase().trim() === "likes") {
        return [
          ...
          `4. Output ONLY this single line of OpenUI Lang — NOTHING ELSE:`,
          ``,
          `root = TumblrFeed("<posts JSON string>", "likes", <count>)`,
          ``,
          `CRITICAL OUTPUT RULES:`,
          `- Your ENTIRE response must be ONLY: root = TumblrFeed(...)`,
          `- Do NOT write any text before or after the component`,
      ...
      return [
        ...
        `4. Output ONLY this single line of OpenUI Lang — NOTHING ELSE:`,
        ``,
        `root = TumblrFeed("<posts JSON string>", "tagged", <count>, "${tag}")`,
        ``,
        `EXAMPLE (with 2 posts):`,
        `root = TumblrFeed("[{\\"type\\":\\"audio\\",\\"id\\":\\"123\\",\\"blog_name\\":\\"jazzfm\\",\\"artist\\":\\"Miles Davis\\",\\"track_name\\":\\"So What\\",\\"tags\\":[\\"jazz\\"],\\"note_count\\":42},{\\"type\\":\\"text\\",\\"id\\":\\"456\\",\\"blog_name\\":\\"musichead\\",\\"title\\":\\"Why Jazz Matters\\",\\"tags\\":[\\"jazz\\"],\\"note_count\\":15}]", "tagged", 2, "jazz")`,
        ``,
        `CRITICAL OUTPUT RULES:`,
        `- Your ENTIRE response must be ONLY: root = TumblrFeed(...)`,
        `- Do NOT write any text before or after the component`,
